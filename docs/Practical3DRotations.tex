...
\lstinputlisting[language=Matlab]{GimbalTestTransforms.m}

\subsection{Helper function for Visualizing Coordinate Frames}
\lstinputlisting[language=Matlab]{plot_coords.m}

\subsection{Helper function for Rotations from Axis-Angle Notation}
\subsubsection{Matrix Representation}
\lstinputlisting[language=Matlab]{rotmat.m}
\subsubsection{Quaternion Representation}
\lstinputlisting[language=Matlab]{rotq.m}
\lstinputlisting[language=Matlab]{inv_q.m}

\subsection{Helper function for Determining Motor Euler Angles (specific to gimbal geometry)}
\subsubsection{Matrix Representation}
\lstinputlisting[language=Matlab]{get_motor_angles.m}
\subsubsection{Quaternion Representation}
\lstinputlisting[language=Matlab]{get_motor_angles_q.m}
